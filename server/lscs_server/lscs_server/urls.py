...
urlpatterns = patterns('',
	...
	url(r'^manager/checklist_distribution/$', 'rest_api.views.manager_checklist_distribution'),
  url(r'^manager/checklist_recently_updated/$', 'rest_api.views.manager_checklist_recently_updated'),
	url(r'^surveyor/checklists/$', 'rest_api.views.surveyor_checklists'),
  url(r'^surveyor/checklist_distribution/$', 'rest_api.views.surveyor_checklist_distribution'),
	url(r'^surveyor/checklist/(?P<pk>[\d]+)/$', 'rest_api.views.surveyor_checklist'),
	url(r'^surveyor/answer/$', 'rest_api.views.surveyor_answer'),
	url(r'^surveyor/checklist_submit/$', 'rest_api.views.surveyor_submit'),
